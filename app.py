...
# - Prepínač "Mobilné zobrazenie" (kompaktnejšie tabuľky).
# - Tabs: Prehľad | Hráč | Export.
# - Logo "logo.png" v koreňovom adresári (favicon + hlavička).
# - Výber hráča je v Prehľade pod tabuľkou; tab Hráč používa tento výber.
...
def main():
    ...
    # --------------------------------------------------------
    # Tab 2: Hráč (detail a súhrny) — používa výber z Prehľadu
    # --------------------------------------------------------
    with tab_hrac:
